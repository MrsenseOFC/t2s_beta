...
import * as Styled from './SemiProPlayer-Styles';
...
export function SemiProPlayer() {
  ...
  return (
    <Styled.SemiProPlayerContainer>

      <AuthWrapper>

        <AuthContainer>
          <Subtitle text="Semi-Profissional" size={theme.sizes.xxlarge} />
